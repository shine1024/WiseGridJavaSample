...
function initWiseGrid(objName, width, height) {
    var WISEGRID_TAG = "<OBJECT ID='" + objName + "'codebase='../../WiseGrid/WiseGridU_v5_3_1_94_ASP.cab#version=5,3,1,94";
...
function initWiseGrid(objName, width, height) {
    ...
    //var WISEGRID_TAG = "<OBJECT ID='" + objName + "' codebase='/WiseGrid/WiseGridU_v5_3_1_80.cab#version=5,3,1,80'";
    WISEGRID_TAG = WISEGRID_TAG + " NAME='" + objName + "' WIDTH=" + width + " HEIGHT=" + height + " border=0";
